...
HD_PWD='E:/xilinx_project/CPUproject/projet_CPU/Projet_2019/project_2019/project_2019.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_cache_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_cache_wrapper.tcl
