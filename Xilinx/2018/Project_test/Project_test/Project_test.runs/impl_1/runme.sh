...
HD_PWD='C:/xilinx_project/git_project/projet_CPU/projet_CPU/Xilinx/2018/Project_test/Project_test/Project_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_interconnect.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_interconnect.tcl -notrace
