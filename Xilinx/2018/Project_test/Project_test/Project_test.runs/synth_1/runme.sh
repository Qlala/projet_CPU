...
HD_PWD='C:/xilinx_project/git_project/projet_CPU/projet_CPU/Xilinx/2018/Project_test/Project_test/Project_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_interconnect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_interconnect.tcl
